...
L0 = [] # Median in first index
L1 = [] # Median in second index
L2 = [] # Median in third index
LS = [] # Median in multiple indicies
    ...
    while progress_made:
        ...
        for list_id in range(len(L)):
            ...
            if round_num < len(cur_list):
                ...
                out_fp.write(',')
                out_fp.write(str(get_median(test_case)))
                out_fp.write('\n')
        round_num += 1 
