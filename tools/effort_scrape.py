...
# Variables to be set
scratch_dir = '/mnt/gs18/scratch/users/fergu358/gptp2019_effort_new/'
start_seed = 140000
num_replicates = 50
...
problems = [prob_smallest, prob_median, prob_grade, prob_for_loop, prob_cmp_str_lens]
#treatments = [trt_full]#trt_cohort, trt_downsampled, trt_truncated]
...
with open('effort_data.csv', 'w') as fp:
    fp.write('problem' \
             + ',' \
             + 'treatment' \
             + ',' \
                        ...
                        with open(scratch_dir + solution_filename, 'r') as tmp_fp:
                            ...
                            for line in tmp_fp:
                                if line.strip() != '':
                                    ...
                                    solution_found = True
                                    first_gen_found = int(line_L[0])
                                    evals = int(line_L[2])
                                    worst_case_evals = int(line_L[1])
