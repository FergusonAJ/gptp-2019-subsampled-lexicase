...
# Treatments
treatments = [trt_cohort, trt_reduced, trt_downsampled, trt_full]#, trt_truncated]
...
def write_job_file(prob, trt, size, dil, out_dir = None, extra_seed = None, \
    ...
    with open(filename, 'w') as fp:
        ...
        fp.write('GENERATIONS=' + str(num_gens)  + '\n')
        fp.write('\n')
...
if __name__ == '__main__':        
    ...
    for prob in problems:
        ...
        for trt in treatments:
            for size in sizes:
                for dil in dilutions:
                    write_job_file(prob, trt, size, dil, hours = 24 * 7 - 1)
