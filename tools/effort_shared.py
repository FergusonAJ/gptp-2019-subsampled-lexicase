...
exec_dir = '/mnt/home/fergu358/lexicase/effort/gptp-2019-subsampled-lexicase'
scratch_dir = '/mnt/gs18/scratch/users/fergu358/gptp2019_effort/'
if scratch_dir[-1] != '/':
    scratch_dir += '/'
output_dir = './jobs'        
if output_dir[-1] != '/':
...
size_100 = SizeInfo(1000, 100, 30000,  1000)
size_50  = SizeInfo(500,  50,  30000,  2000)
size_25  = SizeInfo(250,  25,  30000, 3000)
size_10  = SizeInfo(100,  10,  30000, 4000)
size_5   = SizeInfo(50,   5,   30000, 5000)
